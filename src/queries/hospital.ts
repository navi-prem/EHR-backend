...
const updateDoctor = "update doctor set license_no = $1, name = $2, uid = $3, pass = $4, specialization = $5, hospital_id = $6 where doctor_id = $1;"

export default { getDoctors, addDoctor, deleteDoctor, updateDoctor }
